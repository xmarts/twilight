...
class crm_Claim_ept(models.Model):
    ...
    to_return_picking_ids = fields.Many2many('stock.picking',string='Return Delivery Order',default=False,copy=False)
    ...
    new_sale_id = fields.Many2one('sale.order','Sale Order',copy=False)
